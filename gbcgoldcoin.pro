...
EVENT_INCLUDE_PATH=C:\deps\libevent-2.0.22-stable\include
EVENT_LIB_PATH=C:\deps\libevent-2.0.22-stable\.libs
...
QMAKE_CXXFLAGS_WARN_ON = -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wno-reserved-user-defined-literal -Wformat-security -Wno-unused-parameter -Wstack-protector

# Input
DEPENDPATH += src src/json src/qt src/tor
